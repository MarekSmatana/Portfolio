...
export const products = [
  ...
  {
    name: "Beat It",
    label: "Workout planner & fitness tracker",
    url: "https://getbeatit.app/",
    cta: "View landing page",
    icon: "/app-icons/beat-it.png",
    text: "A workout planner and fitness tracker for smarter plans, focused set-by-set training, progress check-ins, streaks, and AI-assisted performance insights.",
    chips: ["React Native", "Fitness tracker", "Workout planning", "AI insights"],
  },
];
